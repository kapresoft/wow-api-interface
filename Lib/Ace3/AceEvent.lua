...
local _AceEvent = {
    ...
    --- @param callback fun(event:string, ...) : void The callback function to call when the message is triggered (funcref or method, defaults to a method with the event name)
    ...
    --- @param callback fun(event:string, ...) : void The callback function to call when the event is triggered (funcref or method, defaults to a method with the event name)
    --- Notes:
