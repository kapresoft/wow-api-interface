...
---@param defaults AceDBObj_Schema A table of database defaults
---@param defaultProfile string|boolean The name of the default profile. If not set, a character specific profile will be used as the default. You can also pass true to use a shared global profile called "Default".
---@overload fun(tbl:string|table)
---@return AceDBObjectObj DB
--- ---
...
-- AceDBObject-3.0
-- ----------------------------------------------------------------------------
---@class AceDBObjectObj : AceDBObj_Schema
---@field keys AceDBObject_Schema_Keys
---@field sv table
---@field defaults AceDBObj_Schema Cache of defaults
---@field parent table
local DBObjectLib = {}
...
---@param eventName AceDBObj_EventName The name of the event triggering the callback
...
---@param defaults AceDBObj_Schema A table of values to use as defaults
...
---@param eventName AceDBObj_EventName The event to unregister.
...
---@alias AceDBObj_EventName string |"'OnDatabaseReset'" |"'OnDatabaseShutdown'" |"'OnNewProfile'" |"'OnProfileChanged'" |"'OnProfileCopied'" |"'OnProfileDeleted'" |"'OnProfileReset'" |"'OnProfileShutdown'"
--
--

---@class AceDBObj_Schema
