--- #### See: [API_GetSpecialization](https://wowpedia.fandom.com/wiki/API_GetSpecialization)
--- Retail
...
--- #### See: [API_GetActiveTalentGroup](https://wowpedia.fandom.com/wiki/API_GetActiveTalentGroup)
--- Pre-Retail
