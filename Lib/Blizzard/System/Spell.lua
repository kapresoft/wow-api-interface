...
--- [Doc::](https://warcraft.wiki.gg/wiki/API_C_Spell.GetSpellInfo)
--- @class SpellInfoData @Struct returned by C_Spell.GetSpellInfo(spellID)
--- @field public name SpellName The spell Name
--- @field public iconID Icon The icon ID
--- @field public originalIconID Icon The icon ID
--- @field public spellID SpellID The spell ID
--- @field public minRange number The icon ID
--- @field public maxRange number The icon ID
--- @field public castTime number The icon ID
